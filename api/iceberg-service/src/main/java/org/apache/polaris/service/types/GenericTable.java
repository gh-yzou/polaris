...
@ApiModel(description="Generic Table information. - `name` name for the generic table - `format` format for the generic table, i.e. \"delta\", \"csv\" - `properties` properties for the generic table passed on creation - `doc` comment or description for the generic table ")@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaResteasyServerCodegen", date = "2025-03-26T10:48:38.764604-07:00[America/Los_Angeles]", comments = "Generator version: 7.12.0")public class GenericTable   {
  ...
  private Map<String, String> properties;
    ...
    @JsonCreator
    public GenericTable(@JsonProperty(value = "name", required = true) String name, @JsonProperty(value = "format", required = true) String format, @JsonProperty(value = "doc") String doc, @JsonProperty(value = "properties") Map<String, String> properties) {
        this.name = name;
        this.format = format;
        this.doc = doc;
